          ...
          <table class="table table-bordered table-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class='align-middle'>{{ '['.($val->supplier->code ?? '----' ).'] - ' .($val->supplier->description ?? 'Not Found') }}</td>
                <td class='align-middle'>
                  <a href="{{ route('barang.edit', ['id' => $val->id]) }}" class="btn btn-sm btn-primary" type="button"><i
                    class='fas fa-edit'></i></a>
                  <a href="{{ route('barang.destroy', ['id' => $val->id]) }}" onclick="deleteConfirmation(event)" class="btn btn-sm btn-danger" type="button"><i
