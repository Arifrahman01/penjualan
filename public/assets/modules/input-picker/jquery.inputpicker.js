            ...
            for(var i = 0; i < data.length; i++) {
                ...
                for (var j = 0; j < fields.length; j++) {
                    ...
                    if(_isObject(fields[j])){
                        ...
                        // add class with css-name on column
                        if(fields[j]['col_class']){
                            custom_style +=" "+fields[j]['col_class'];                          
                        }
                    }
                    output += ' class="' + custom_style + '" title="'+text+'"';
    ...
    function _dataRenderDefault(input) {
        ...
        if(data.length){
            ...
            for(var i = 0; i < data.length; i++) {
                ...
                //eq: {'name':'NO SPK','col_custom':'white-space:nowrap'}
